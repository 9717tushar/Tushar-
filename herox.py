...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel=" _INJECTOR7H"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "ʟᴀᴅᴋɪ ᴛʜɪ ᴄʜᴏᴅ ᴅɪʏᴀ 😂 ᖇEᑭᒪY ᖇᗩIᗪ [ᗪE-ᗩᑕTIᐯᗩTEᗪ]\n           〄 ╔»⟦★ʜᴇʀᴏx ᴏᴘ ★⟧«╗ SᑭᗩᗰᗰEᖇ ᗷOT 〄"
            await e.reply(text, parse_mode=None, link_preview=None )
        elif e.reply_to_msg_id:             
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"ᴋʏᴀ ᴅᴇᴋʀᴀ ʙᴇ ʀᴀɴᴅɪ ᴋᴇ ᴄʜᴏᴅᴇ !\n`{ms}` 𝗺𝘀\n           ⚔️ʜᴇʀᴏx ᴏᴘ sᴘᴀᴍʙᴏᴛ⚔️")
...
text = """ʜᴇʀᴏx ᴏᴘ sᴘᴀᴍʙᴏᴛ"""

print(text)
print("")
print("SMEX! ʜᴇʀᴏx ᴏᴘ sᴘᴀᴍʙᴏᴛ STARTED.")
